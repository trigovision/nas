...
from nas.imagenet_classification.data_providers.imagenet import ImagenetDataProvider
from nas.imagenet_classification.run_manager import ImagenetRunConfig, RunManager
from nas.model_zoo import ofa_net


parser = argparse.ArgumentParser()
parser.add_argument("-p", "--path", help="The path of imagenet", type=str, default="/dataset/imagenet")
