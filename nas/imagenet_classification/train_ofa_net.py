...
from nas.imagenet_classification.elastic_nn.modules.dynamic_op import (
    DynamicSeparableConv2d,
)
from nas.imagenet_classification.elastic_nn.networks import OFAMobileNetV3
from nas.imagenet_classification.run_manager import DistributedImageNetRunConfig
from nas.imagenet_classification.networks import MobileNetV3Large
from nas.imagenet_classification.run_manager.distributed_run_manager import (
    DistributedRunManager,
)
from nas.utils import download_url, MyRandomResizedCrop
from nas.imagenet_classification.elastic_nn.training.progressive_shrinking import (
    load_models,
)
    ...
    if args.task == "kernel":
        ...
        if distributed_run_manager.start_epoch == 0:
            ...
            distributed_run_manager.write_log(
                "%.3f\t%.3f\t%.3f\t%s" % validate(distributed_run_manager, is_test=True, **validate_func_dict),
                "valid",
            )
        else:
            assert args.resume
