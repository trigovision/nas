...
from nas.imagenet_classification.elastic_nn.modules.dynamic_layers import DynamicConvLayer, DynamicResNetBottleneckBlock
from nas.imagenet_classification.networks import ResNets
from nas.pose.networks.pose import PAC_EMBEDDING_DIM
from nas.pose.networks.resnet import PResNet
from nas.utils import make_divisible, MyNetwork, val2list
from nas.utils.layers import IdentityLayer, ResidualBlock


class POFAResNet(PResNet):
    def __init__(
        self,
        depth_list=2,
        ...
        # blocks
        blocks = []
        for depth, width, s, d in zip(n_block_list, stage_width_list, stride_list, dilation_list):
        ...
        super(POFAResNet, self).__init__(input_stem, blocks)
